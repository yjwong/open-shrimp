...
OpenCode requires provider-qualified models, an out-of-band `opencode auth login`, and a discoverable `opencode` binary. See [Agent Backends](/guides/backends/) for full setup.
