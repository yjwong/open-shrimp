...
Telegram <-> bot.py / handlers/ <-> client_manager.py <-> backend/ (claude_sdk | opencode)
                                          |                    |
              config.py (YAML) ── db.py (SQLite) ──── sandbox/ (docker | libvirt | lima)
```
